...
<nav aria-label="breadcrumb" class="my-4">
	<ol class="breadcrumb">
		...
		<li class="breadcrumb-item active" aria-current="page">Insert Bundle</li>
	</ol>
</nav>
...
<div class="card rounded">
	<div class="card-header bg-light h5"><i class="fas fa-plus-square"></i> Insert Bundle</div>
	<div class="card-body">
		<div class="row">
			<div class="col-md-8 offset-md-2">
				<form method="post" enctype="multipart/form-data" class="needs-validation" novalidate>
				  <div class="form-row mb-3">
				    ...
				    <div class="col-md-9">
				    	<input type="text" name="product_title" class="form-control" id="product_title" placeholder="Bundle Title" required>
					...
					<div class="form-row mb-3">
						...
						<div class="col-md-9">
							<select name="product_cat" id="product_cat" class="form-control" required>
								<option value="">----- Select a Bundle Category -----</option>
								<?php
				  ...
				  <div class="form-row mb-3">
				    ...
				    <div class="col-md-9">
				    	<input type="number" name="product_price" class="form-control" id="product_price" placeholder="Enter Bundle Price" required>
				      <div class="invalid-feedback">
				  ...
				  <div class="form-row mb-3">
				    <div class="col-md-3">
				      <label for="product_price">Bundle Sale Price</label>
				    </div>
				    <div class="col-md-9">
				    	<input type="number" name="product_psp_price" class="form-control" id="product_price" placeholder="Enter Bundle Sale Price" required>
				      <div class="invalid-feedback">
				    	...
				    	<ul class="nav nav-tabs" id="myTab" role="tablist">
							...
							<div class="tab-content" id="myTabContent">
							  <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
							  	<textarea name="product_desc" class="form-control summernote" rows="15" id="product_desc" placeholder="Enter Bundle Description" required></textarea>
						      <div class="invalid-feedback">
						        Please provide Bundle Description.
						      </div>
							  </div>
							  <div class="tab-pane fade" id="profile" role="tabpanel" aria-labelledby="profile-tab">
							  	<textarea name="product_features" class="form-control summernote" rows="15"  id="product_features" placeholder="Enter Bundle Video" required></textarea>
						      <div class="invalid-feedback">
						        Please provide Bundle Features.
						      </div>
							  </div>
							  <div class="tab-pane fade" id="contact" role="tabpanel" aria-labelledby="contact-tab">
							  	<textarea name="product_video" class="form-control summernote" rows="15" id="product_video" placeholder="Enter Bundle Video" required></textarea>
						      <div class="invalid-feedback">
				  ...
				  <div class="form-row mb-3">
				    ...
				    <div class="col-md-9">
				    	<input type="text" name="product_keywords" class="form-control" id="product_keywords" placeholder="Enter Bundle Keyword" required>
				      <div class="invalid-feedback">
				  ...
				  <div class="form-row mb-3">
				    <div class="col-3 ">
				      <label for="product_label">Bundle Label</label>
				    </div>
				    <div class="col-md-9">
				  ...
				  <div class="row">
				  	<div class="col-12 my-5">
				  		<button class="btn btn-info form-control" name="submit" type="submit"><i class="fas fa-plus-circle"></i> Insert Bundle</button>
				  	</div>
				  </div>
				</form>
			</div>
