...
<?php
	...
	if (isset($_POST['add_service'])) {
		...
		if ($count_services >= 3) {
			...
			$insert_service = $getFromU->create("services", array("service_title" => $service_title, "service_desc" => $service_desc, "service_image" => $service_image, "service_button" => $service_button, "service_url" => $service_url));
			...
			<div class="col-md-8 offset-md-2">
				<form method="post" enctype="multipart/form-data" class="needs-validation" novalidate>
				  ...
				  <div class="form-row mb-3">
				    ...
				    <div class="col-md-9">
				    	<input type="text" name="service_button" class="form-control" id="service_button" placeholder="Service Button" required>
				      <div class="invalid-feedback">
				  ...
				  <div class="form-row mb-3">
				    ...
				    <div class="col-md-9">
				    	<input type="text" name="service_url" class="form-control" id="service_url" placeholder="Service URL" required>
				      <div class="invalid-feedback">
